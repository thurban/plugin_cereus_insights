...
function cereus_insights_config_settings() {
	...
	$settings['cereus_insights'] = array(
		...
		'cereus_insights_llm_enabled' => array(
			'friendly_name' => __('Enable LLM Alert Summarization', 'cereus_insights'),
			'description'   => __('When disabled, Thold breach events are not queued and no LLM calls are made. All other Cereus Insights features continue to operate normally.', 'cereus_insights'),
			'method'        => 'checkbox',
			'default'       => 'on',
		),
		'cereus_insights_llm_proxy' => array(
			'friendly_name' => __('HTTP Proxy', 'cereus_insights'),
			'description'   => __('Proxy server for outbound LLM API calls, e.g. http://proxy.example.com:3128 or socks5://proxy.example.com:1080. Leave blank for direct internet access. Required when the Cacti server can only reach the internet through a proxy.', 'cereus_insights'),
			'method'        => 'textbox',
			'default'       => '',
			'max_length'    => 255,
			'size'          => 60,
		...
		'cereus_insights_report_header' => array(
			'friendly_name' => __('Weekly Intelligence Report', 'cereus_insights')
				. ($tier !== 'enterprise' ? ' &mdash; ' . __('Enterprise license required', 'cereus_insights') : ''),
			'method'        => 'spacer',
		),
		'cereus_insights_report_enabled' => array(
			'friendly_name' => __('Enable Weekly Intelligence Report', 'cereus_insights'),
			'description'   => __('When enabled, a weekly report summarising anomalies, capacity concerns, and action items is generated by the LLM and emailed on the configured day and hour.', 'cereus_insights'),
			'method'        => 'checkbox',
			'default'       => '',
		),
		'cereus_insights_report_dow' => array(
			'friendly_name' => __('Report Day of Week', 'cereus_insights'),
			'description'   => __('Day of the week on which the weekly report is generated and sent.', 'cereus_insights'),
			'method'        => 'drop_array',
			'default'       => '1',
			'array'         => array(
				'0' => __('Sunday',    'cereus_insights'),
				'1' => __('Monday',    'cereus_insights'),
				'2' => __('Tuesday',   'cereus_insights'),
				'3' => __('Wednesday', 'cereus_insights'),
				'4' => __('Thursday',  'cereus_insights'),
				'5' => __('Friday',    'cereus_insights'),
				'6' => __('Saturday',  'cereus_insights'),
			),
		),
		'cereus_insights_report_hour' => array(
			'friendly_name' => __('Report Hour (0–23)', 'cereus_insights'),
			'description'   => __('Hour of the day (server local time) at which the weekly report is generated. Default: 6 (6 AM).', 'cereus_insights'),
			'method'        => 'textbox',
			'default'       => '6',
			'max_length'    => 2,
			'size'          => 3,
		),
		'cereus_insights_report_email' => array(
			'friendly_name' => __('Report Recipient Email', 'cereus_insights'),
			'description'   => __('Email address for the weekly intelligence report. Leave blank to use the Cacti admin email.', 'cereus_insights'),
			'method'        => 'textbox',
			'default'       => '',
			'max_length'    => 255,
			'size'          => 40,
		),
		'cereus_insights_report_items' => array(
			'friendly_name' => __('Top Items per Section', 'cereus_insights'),
			'description'   => __('Number of top devices/datasources to include in each report section. Default: 5.', 'cereus_insights'),
			'method'        => 'textbox',
			'default'       => '5',
			'max_length'    => 2,
			'size'          => 3,
